...
\end{align*}	
\item \lstinputlisting[style=Matlab-editor,basicstyle=\mlttfamily]{progs/matlab/whiteNoisePlots.m}
...
\item \lstinputlisting[style=Matlab-editor,basicstyle=\mlttfamily]{progs/matlab/arPlots.m}
